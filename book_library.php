<?php
/************************************************
* Module: book_library.php						*
* Author Name: J.D. Stone						*
* 												*
* Purpose: Pull library from database and show	*
*		   to user								*
*************************************************/
...
if ((isset($_GET['delete'])) && (is_numeric($_GET['delete']))) {
	$books->deleteBookRecord($_GET['delete']);
}
...
<title>StoneLibrary - My Books</title>
...
<div class="container">
  <div class="sidebar1">
	<?php echo $books->buildNavBar("books", $logoutAction); ?>
  </div>
  <div class="content">
	<!-- **future feature** When library is empty, offer to 'add media' -->
	<?php $books->buildLibrary("books"); ?>
  </div>
